...
// import 'samayLogic.dart';

var temp;
// var samayList = new Map();
var samayList = {};
var samayTimings;
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Column(
              children: [
                ...
                Align(
                  alignment: Alignment.topLeft,
                  child: Text(
                    'Select suitable ${samayTimings['samay404AM']} timings for Samay Sampana reminder',
                    style: TextStyle(
                        fontFamily: 'Roboto',
                        fontSize: 14.0,
                        color: Colors.black54),
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            filterChipWidget(
                              ...
                              chipName: '04:04',
                              selectChip: samayTimings['samay404AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay505AM',
                              chipName: '05:05',
                              selectChip: samayTimings['samay505AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay606AM',
                              chipName: '06:06',
                              selectChip: samayTimings['samay606AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay707AM',
                              chipName: '07:07',
                              selectChip: samayTimings['samay707AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay808AM',
                              chipName: '08:08',
                              selectChip: samayTimings['samay808AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay909AM',
                              chipName: '09:09',
                              selectChip: samayTimings['samay909AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay1010AM',
                              chipName: '10:10',
                              selectChip: samayTimings['samay1010AM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay1111AM',
                              chipName: '11:11',
                              selectChip: samayTimings['samay1111AM'],
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            filterChipWidget(
                              ...
                              chipName: '12:12',
                              selectChip: samayTimings['samay1212PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay101PM',
                              chipName: '01:01',
                              selectChip: samayTimings['samay101PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay202PM',
                              chipName: '02:02',
                              selectChip: samayTimings['samay202PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay303PM',
                              chipName: '03:03',
                              selectChip: samayTimings['samay303PM'],
                            ),
                          ],
                        ),
                      ),
            ...
            // filterchips = [].add  =====>>>> save () { http.post / http.put}
            Stack(
              children: <Widget>[
                Card(
                  child: Padding(
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            filterChipWidget(
                              ...
                              chipName: '04:04',
                              selectChip: samayTimings['samay404PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay505PM',
                              chipName: '05:05',
                              selectChip: samayTimings['samay505PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay606PM',
                              chipName: '06:06',
                              selectChip: samayTimings['samay606PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay707PM',
                              chipName: '07:07',
                              selectChip: samayTimings['samay707PM'],
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            filterChipWidget(
                              ...
                              chipName: '08:08',
                              selectChip: samayTimings['samay808PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay909PM',
                              chipName: '09:09',
                              selectChip: samayTimings['samay909PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay1010PM',
                              chipName: '10:10',
                              selectChip: samayTimings['samay1010PM'],
                            ),
                            filterChipWidget(
                              samayLabel: 'samay1111PM',
                              chipName: '11:11',
                              selectChip: samayTimings['samay1111PM'],
                            ),
                          ],
                        ),
                      ),
...
class filterChipWidget extends StatefulWidget {
  ...
  filterChipWidget({Key? key, required this.chipName, required this.samayLabel, this.selectChip : false})
      : super(key: key);
